...
- Microsoft Azure (Virtual Machines, Networking, Storage)
- Microsoft Entra ID (Azure Active Directory concepts)
...
### ☁️ Azure Virtual Machine Lab
- Deploying and managing Windows virtual machines in Azure
- Connecting using Remote Desktop Protocol (RDP)
- Managing compute resources and system configuration

### 🔐 Identity & Access Management Lab (Entra ID)
- Creating users and security groups
- Managing roles and permissions
- Practicing identity management concepts
